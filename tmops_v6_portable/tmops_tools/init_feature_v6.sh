...
- Use instance-specific instructions from: tmops_v6_portable/instance_instructions/
- Orchestrator: 01_orchestrator.md
- Tester: 02_tester.md  
- Implementer: 03_implementer.md
- Verifier: 04_verifier.md
EOF
fi
...
if [ "$RUN_TYPE" = "initial" ]; then
    ...
    echo "3. Use instance instructions from tmops_v6_portable/instance_instructions/"
