<!--
📁 FILE: /home/anthonycalek/projects/tmops_framework/CODE/tmops-header-standardization/tmops_v6_portable/templates/00_research_template.md
🎯 PURPOSE: Template for systematic research reports with AI instructions for prior art analysis and technical feasibility
🤖 AI-HINT: Use as starting point for research phase documentation with structured methodology and source tracking
🔗 DEPENDENCIES: Research workflow, preflight researcher instance, discovery phase
📝 CONTEXT: Part of template library for standardized research documentation with AI-ready instructions
-->
