<!--
📁 FILE: /home/anthonycalek/projects/tmops_framework/CODE/tmops-header-standardization/tmops_v6_portable/templates/01_plan_template.md
🎯 PURPOSE: Template for strategic project planning with AI instructions for milestones, resources, and success metrics
🤖 AI-HINT: Use as starting point for strategic planning documentation with structured methodology and stakeholder tracking
🔗 DEPENDENCIES: Research reports, discovery documents, planning workflow
📝 CONTEXT: Part of template library for standardized strategic planning with AI-ready project management structure
-->
